                        ...
                        <div class="product product-style-2 equal-elem ">
                            <div class="product-thumnail">
                                <a href="{{url('product/details/'.$item->id)}}" title="T-Shirt Raw Hem Organic Boro Constrast Denim">
                                    <figure><img src="{{asset("uploads/product/$item->image")}}" width="800" height="800" alt="T-Shirt Raw Hem Organic Boro Constrast Denim"></figure>
                                </a>
                            ...
                            <div class="product-info">
                                ...
                                <div class="wrap-price">
                                    ...
                                    @else
                                    <span class="product-price">{{round($item->discount_price)}}%</span>
                                    @endif
                                </div>
                            </div>
                        </div>
